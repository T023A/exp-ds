...
- Unordered set - If you have a use case where you only want to insert/find/erase Int64 keys (or hashes) without iterating through all elements, the implementation in the project benchmarks faster for 3 million randomly generated Int64s compared to Abseil - flash hash set; in the attached tests. The repo has the source implementation for the unordered set and corresponding profiling code.
